...
const Card = ({ image, alt, year, githubLink, websiteLink, header, body, tools }) => {
  return (
    <figure className="group w-full relative mb-4 drop-shadow-md rounded-lg overflow-hidden">
      <img src={image} alt={alt} className="aspect-[3/2] group-hover:scale-110 transition-all duration-200" />
        ...
        <div className="">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3 text-darkgraymuted-500">
              {githubLink && (
                <a href={githubLink} target="_blank" className="hover:text-green-500 transition-all duration-300">
                  <FaGithub size={20} />
                </a>
              )}
              {websiteLink && (
                <a href={websiteLink} target="_blank" className="hover:text-green-500 transition-all duration-300">
