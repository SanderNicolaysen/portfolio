...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed z-10 w-full top-0 left-0 h-20 items-center flex px-6 md:px-12 justify-between backdrop-blur text-white text-2xl bg-darkGray-500 dark:bg-secondary`}
      >
        <Link
          onClick={handleClick}
        ...
        <ul
          className={`${
            isOpen
              ? 'fixed bg-darkGray-500 top-0 left-0 pt-5 mt-20 h-[calc(100vh-5rem)] w-full flex flex-col items-center justify-center gap-16 px-6 border-t-2 border-gray-500'
        ...
        >
          ...
          <li>
            <Link onClick={handleClick} className="animated-b-border" to="skills" smooth={true} duration={500}>
              Skills
            </Link>
          </li>
          <li>
